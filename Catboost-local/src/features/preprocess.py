...
import sys
sys.path.insert(0, '/home/ec2-user/SageMaker/Accessbank_CTR/Catboost-local/src')
...
#         data = data.dropna(thresh=data.shape[1]*0.8)
        ...
        data = drop_cols(dataframe,columns=['msisdn.1'])
        ...
        data = drop_cols(data,columns=['msisdn.1','msisdn'])
