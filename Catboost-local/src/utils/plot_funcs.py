...
def multiple_roc_curve(alg,roc_list,fp):
    fig = plt.figure(figsize=(8,6))

    for model in alg:
        plt.plot(roc_list[model.__class__.__name__][0], 
                 roc_list[model.__class__.__name__][1], 
                 label="{}, AUC={:.3f}".format(model.__class__.__name__, roc_list[model.__class__.__name__][2]))
